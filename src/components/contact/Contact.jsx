        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">jawaharjr26@gmail.com</span>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+91 7708018318</span>

              <a
                href="https://api.whatsapp.com/send?phone=917708018318"
                className="contact__button"
              >
                Write me
                <bx className="bx bx-right-arrow-alt contact__button-icon"></bx>
